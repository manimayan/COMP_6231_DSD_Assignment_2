...
public class MontrealServer extends DCMSInterfacePOA {
	...
	public void serverConnection(int port, MontrealServer montrealServerArg) {
		...
		/*
		 * MontrealServer montrealServer = montrealServerArg; Registry registry1 =
		 * LocateRegistry.createRegistry(9991); registry1.bind("Montreal",
		 * montrealServer);
		 */
	...
	public String findRecord(String recordID) {
		return this.mainServer.findAndRemoveRecordInmap(recordID, LogWriter.MONTREAL, this.teacherStudentRecords);
	}
